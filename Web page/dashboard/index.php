	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-5 input-section">
				...
				<form class="user-form" action="updateUOID.php" method="POST">
					<div class="inputField">
						<input type="text" placeholder=" " name="uoid" autocomplete="on" value="<?php echo $_SESSION["UOID"]; ?>" />
						<span>Unique OTP ID   </span>
					</div>
